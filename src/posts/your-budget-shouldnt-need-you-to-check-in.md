...
data, sqlite to store local data, Mac launchtl to run this as an always-on
service, [Telegram](https://telegram.org/) to handle the UX, and [Claude]() to interpret reports and
